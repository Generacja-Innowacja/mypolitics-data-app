...
const ReportFindings = ({ reportData, isLoading }: Props): JSX.Element | null => {
    const isMobile = useIsMobile();
    const [questionIndex, setQuestionIndex] = useState<number>(0);
    const questionsWithFindings = (reportData?.questions || []).filter(q => q.finding);
