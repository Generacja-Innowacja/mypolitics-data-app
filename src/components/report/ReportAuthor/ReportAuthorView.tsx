...
const ReportAuthor = ({ author }: Props): JSX.Element => {
    ...
    return (
        <LayoutGroup>
            <AnimateChangeInHeight duration={0.3} className="bg-white rounded-[32px] border border-dark-sea-storm/10 overflow-hidden">
                    ...
                    <div className="flex justify-between items-center">
                        ...
                        <div className="flex gap-2 items-center">
                            ...
                            <Button styleType="outlined" isIconButton onClick={toggleDescription}>
                                <ChevronDownIcon className={twMerge(`h-6 transition-all duration-300 ${isDescriptionShown ? 'rotate-0' : 'rotate-180'}`)} />
                            </Button>
                        </div>
                    </div>
