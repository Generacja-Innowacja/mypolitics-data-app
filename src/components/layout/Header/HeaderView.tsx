    ...
    <header className="flex w-full py-6 border-b border-bluish-gray justify-center">
      <div className="flex justify-between items-center w-full max-w-screen-xl mx-6">
        ...
        <nav className="flex items-center gap-3">
          ...
          <HeaderNavElement href={PATHS.QUIZZES} icon={<QuizIcon />} text="Quizy" className="hidden md:flex" />
          <HeaderNavElement
            href={PATHS.MLODZI_WYBORCY}
            icon={
              <Image src="/assets/mlodzi-wyborcy/mlodzi-wyborcy-logo-dark.svg" alt="Młodzi Wyborcy 2025 Logo" height={16} width={50} />
            }
            isHighlighted
          />
        </nav>
