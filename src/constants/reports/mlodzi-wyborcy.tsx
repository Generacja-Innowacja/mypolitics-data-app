      ...
      authors: [
        {
          ...
          description: "Założyciel portalu myPolitics i Fundacji Generacja Innowacja. Główny koordynator raportu #MłodziWyborcy2025, odpowiedzialny za kształt badania i analizę danych.",
          socials: {
      ...
      authors: [
        {
          ...
          description: "Head of Knowledge w Generacja Innowacja. Programista, specjalista ds. AI/ML. Analityk wykorzystujący narzędzia sztucznej inteligencji do analizy politycznej.",
          socials: {
        ...
        },
        {
          ...
          socials: {
            linkedIn: "https://www.linkedin.com/in/maksymilian-mirecki-ab8126274",
          },
        },
        {
        ...
        },
        {
          ...
          description: "Pasjonatka polityki. Entuzjastka działań na rzecz rozwoju świadomego społeczeństwa obywatelskiego i otwartego dialogu publicznego. Prywatnie UX/UI designerka.",
          socials: {
    ...
    },
    {
      ...
      authors: [
        ...
        },
        {
          ...
          description: "Front-end developer. Jest wolontariuszem od kwietnia 2025. Jego zainteresowania to kompozycja/produkcja muzyki oraz montaż wideo.",
          socials: {},
        },
        {
          name: "Daniel Kłoda",
          ...
          description: "Back-end developer i koordynator praktyk, który kocha muzykę oraz z pasją zanurza się w filmy, seriale i gry. Łączy techniczną precyzję z kreatywnymi inspiracjami.",
          socials: {
