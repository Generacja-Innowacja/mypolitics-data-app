...
export const MLODZI_WYBORCY_REPORT: CommonReport = {
    ...
    dataLinks: [
        ...
        },
        {
            ...
            description: (
                <>
                    Zbiór losowo dobranych <b className="font-bold">5 000</b> kwestionariuszy uwzględniających odpowiedzi respondentów na wszystkie pytania, a także metryczkę.
                </>
            ),
            file: {
                extension: 'csv',
        ...
        },
        {
            ...
            description: (
                <>
                    Zbiór wszystkich <b className="font-bold">350 000</b> kwestionariuszy z metryczką. Dostęp do tych danych jest możliwy wyłącznie po uprzednim skontaktowaniu się z nami i właściwym uzasadnieniu prośby.
                    <br /><br />
                    Udostępniamy pełny zbiór danych jedynie w przypadku gdy cel pozyskującego jest zgodny z wartościami portalu myPolitics.
                </>
            ),
        },
    ]
